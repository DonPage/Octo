...
class Octo {
    ...
    getAttr(selector, attribute) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(yield el.getAttribute(attribute));
            return yield el.getAttribute(attribute);
        });
    }
    waitForDisplayed(selector) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.waitForLocated(selector);
            yield this.waitForVisible(selector);
            return;
        });
    }
    ...
    wrapElement(selector) {
        return {
            ...
            waitForDisplayed: () => __awaiter(this, void 0, void 0, function* () { return yield this.waitForDisplayed(selector); }),
